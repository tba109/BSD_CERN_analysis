...
// Fri Jul  5 16:54:29 2013 by ROOT version 5.32/01
// from TChain t/
//////////////////////////////////////////////////////////

#ifndef punch_thru_correlation_search_h
#define punch_thru_correlation_search_h
...
class punch_thru_correlation_search {
public :
   ...
   punch_thru_correlation_search(TTree *tree=0);
   virtual ~punch_thru_correlation_search();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(Int_t myType = 2, Int_t myEnergy = 350);
...
#ifdef punch_thru_correlation_search_cxx
punch_thru_correlation_search::punch_thru_correlation_search(TTree *tree) : fChain(0) 
{
...
punch_thru_correlation_search::~punch_thru_correlation_search()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t punch_thru_correlation_search::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t punch_thru_correlation_search::LoadTree(Long64_t entry)
{
...
void punch_thru_correlation_search::Init(TTree *tree)
{
...
Bool_t punch_thru_correlation_search::Notify()
{
...
void punch_thru_correlation_search::Show(Long64_t entry)
{
...
Int_t punch_thru_correlation_search::Cut(Long64_t entry)
{
...
#endif // #ifdef punch_thru_correlation_search_cxx
