...
// Mon Jul 29 10:27:01 2013 by ROOT version 5.32/01
// from TChain t/
//////////////////////////////////////////////////////////

#ifndef make_all_histos_h
#define make_all_histos_h
...
public :
   ...
   make_all_histos(TTree *tree=0);
   virtual ~make_all_histos();
...
#ifdef make_all_histos_cxx
make_all_histos::make_all_histos(TTree *tree) : fChain(0) 
{
...
make_all_histos::~make_all_histos()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t make_all_histos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t make_all_histos::LoadTree(Long64_t entry)
{
...
void make_all_histos::Init(TTree *tree)
{
...
void make_all_histos::Show(Long64_t entry)
{
...
Int_t make_all_histos::Cut(Long64_t entry)
{
...
#endif // #ifdef make_all_histos_cxx
