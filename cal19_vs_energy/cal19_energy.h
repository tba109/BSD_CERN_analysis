...
// Tue Dec 11 08:48:14 2012 by ROOT version 5.32/01
// from TChain t/
//////////////////////////////////////////////////////////

#ifndef cal19_energy_h
#define cal19_energy_h
...
public :
   ...
   cal19_energy(TTree *tree=0);
   virtual ~cal19_energy();
...
#ifdef cal19_energy_cxx
cal19_energy::cal19_energy(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/tyler/CERN2012/BSDCALCombined/BSDCALCombined_11-30-2012-21-38-17.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/tyler/CERN2012/BSDCALCombined/BSDCALCombined_11-30-2012-21-38-17.root");
      }
      f->GetObject("t",tree);
...
cal19_energy::~cal19_energy()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t cal19_energy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cal19_energy::LoadTree(Long64_t entry)
{
...
void cal19_energy::Init(TTree *tree)
{
...
void cal19_energy::Show(Long64_t entry)
{
...
Int_t cal19_energy::Cut(Long64_t entry)
{
