#define Efrac_vs_CALSum_cxx
#include "Efrac_vs_CALSum.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TGraph.h>

void Efrac_vs_CALSum::Loop()
{
