...
#ifdef cal_energy_cxx
cal_energy::cal_energy(TTree *tree) : fChain(0) 
{
...
Int_t cal_energy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cal_energy::LoadTree(Long64_t entry)
{
...
void cal_energy::Init(TTree *tree)
{
...
void cal_energy::Show(Long64_t entry)
{
...
Int_t cal_energy::Cut(Long64_t entry)
{
