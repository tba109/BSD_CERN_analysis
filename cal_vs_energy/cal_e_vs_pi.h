...
// Tue Dec 11 11:43:56 2012 by ROOT version 5.32/01
// from TChain t/
//////////////////////////////////////////////////////////

#ifndef cal_e_vs_pi_h
#define cal_e_vs_pi_h
...
#ifdef cal_e_vs_pi_cxx
cal_e_vs_pi::cal_e_vs_pi(TTree *tree) : fChain(0) 
{
...
cal_e_vs_pi::~cal_e_vs_pi()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t cal_e_vs_pi::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cal_e_vs_pi::LoadTree(Long64_t entry)
{
...
void cal_e_vs_pi::Init(TTree *tree)
{
...
void cal_e_vs_pi::Show(Long64_t entry)
{
...
Int_t cal_e_vs_pi::Cut(Long64_t entry)
{
