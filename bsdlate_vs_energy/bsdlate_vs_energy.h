...
// Tue Dec 11 11:05:31 2012 by ROOT version 5.32/01
// from TChain t/
//////////////////////////////////////////////////////////

#ifndef bsdlate_vs_energy_h
#define bsdlate_vs_energy_h
...
public :
   ...
   bsdlate_vs_energy(TTree *tree=0);
   virtual ~bsdlate_vs_energy();
...
#ifdef bsdlate_vs_energy_cxx
bsdlate_vs_energy::bsdlate_vs_energy(TTree *tree) : fChain(0) 
{
...
bsdlate_vs_energy::~bsdlate_vs_energy()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t bsdlate_vs_energy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t bsdlate_vs_energy::LoadTree(Long64_t entry)
{
...
void bsdlate_vs_energy::Init(TTree *tree)
{
...
Bool_t bsdlate_vs_energy::Notify()
{
...
void bsdlate_vs_energy::Show(Long64_t entry)
{
...
Int_t bsdlate_vs_energy::Cut(Long64_t entry)
{
...
#endif // #ifdef bsdlate_vs_energy_cxx
